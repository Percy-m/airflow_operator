...
class HttpClient:
    """Synchronous HTTP client used by compute operators and triggers."""
    ...
    def __init__(
        ...
        *,
        ...
        api_error_cls: type[AiDatalakeApiError] = AiDatalakeApiError,
    ) -> None:
    ...
    def request(
        ...
        *,
        ...
        raise self.api_error_cls(f"HTTP {method} {url} failed: {last_error}", retryable=True)
